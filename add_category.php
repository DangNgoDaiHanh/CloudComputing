    ...
    <div id="main" class="container">     
        ...
        <?php
           ...
           $db_link = $conn->connectToPDO();
                ...
                $value = $_GET['cid'];
                $sqlSelect = "select*from category where pCart_id = ?";
        ...
        if(isset($_POST['btnAdd'])): //add action
                $sqlInsert = "INSERT INTO `category`(`pCart_id`, `catName`) VALUES (?, ?)";
                ...
                $sqlUpdate ="UPDATE `category` SET `pCart_id`=?,`catName`=? WHERE `pCart_id`=?";
